...
def vsr_simulate(params):
    ...
    fitness = abs(metric_dictionary.get("DELTA_X"))
    description = np.array([((metric_dictionary.get("DELTA_X"))+100)/200, metric_dictionary.get("INTEGRAL_Theta")*50])
